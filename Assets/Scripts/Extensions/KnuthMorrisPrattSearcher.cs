...
public static class KnuthMorrisPrattSearcher
{
    /// <summary>
    ...
    /// </returns>
    public static IEnumerable<int> FindIndexes(FixedString512Bytes str, FixedString32Bytes pat)
    {
    ...
    public static int[] FindLongestPrefixSuffixValues(FixedString32Bytes pat)
    {
